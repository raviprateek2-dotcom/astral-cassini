...
class Interview(BaseModel):
    """An interview scheduled by the Hiring Ops Coordinator (Agent 7)."""
    id: str = Field(default_factory=lambda: str(uuid.uuid4()))
    candidate_id: str
    candidate_name: str
...
class Assessment(BaseModel):
    """Competency assessment from the Hiring Ops Coordinator pipeline (Agent 7)."""
    candidate_id: str
    candidate_name: str
...
class Recommendation(BaseModel):
    """Final hire recommendation from the Hiring Ops Coordinator / decider logic (Agent 7)."""
    candidate_id: str
    candidate_name: str
...
class DecisionTrace(BaseModel):
    """Per-candidate deterministic decision trace for explainability."""
    candidate_id: str
    candidate_name: str
    screening_score: float = 0.0
    interview_score_scaled: float = 0.0
    concerns_count: int = 0
    weighted_score: float = 0.0
    decision: str = "no_hire"
    rule_applied: str = ""


class OutreachEmail(BaseModel):
    """Outreach email generated by the Outreach agent (Agent 5)."""
    candidate_id: str
    candidate_name: str
    subject: str = ""
    body: str = ""
...
class CandidateResponse(BaseModel):
    """Inbound engagement response from a candidate."""
    candidate_id: str
    candidate_name: str
    response: str = ""
...
class OfferRecord(BaseModel):
    """Offer letter generated at the offer stage (Offer Generator module)."""
    candidate_id: str
    candidate_name: str
    offer_markdown: str = ""
    salary_offered: str = ""
...
class SharedState(BaseModel):
    ...
    # --- Agent 5: Outreach | Agent 6: Response Tracker ---
